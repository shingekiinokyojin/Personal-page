...
def login():
    ...
    if form.validate_on_submit():
        ...
        # Password incorrect    
        elif not check_password_hash(selected_user.password, given_password):
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, form=form, current_user=current_user, year=year, gravatar=gravatar)
...
def contact():
    ...
    return render_template("contact.html", current_user=current_user, year=year, msg_sent=False)
